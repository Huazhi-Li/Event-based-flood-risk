...
# path = 'c:/Users/hli490/Desktop/Paper2/Hazard/'
...
extent0 = pd.read_csv(os.path.join(path, 'Extent/extent.csv'))
extent = extent0.loc[extent0['Basin']==basin]
minx, maxx, miny, maxy = extent.iloc[0,1], extent.iloc[0,2], extent.iloc[0,3], extent.iloc[0,4]


# Open station file
df_station = pd.read_csv(os.path.join(path, 'Stations/'+basin+'.csv'))
...
# Save to nc 
outdir = os.path.join(path, 'Source_station/src_station_rp1000_{:s}.nc'.format(basin))
